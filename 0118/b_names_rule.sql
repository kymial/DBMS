...
# 5. mySQL 예약어는 사용 하지않는다. (권장)
# 예약어 : 컴퓨터 프로그래밍의 문법 체계명 ( 예: create, drop, use)
# >> 예약어를 사용해야하는 경우 백틱(``)으로 묶어서 사용

# SQL내에 올바른 이름 사용을 위해서는 의미있는 이름 사용
# : 그 내용을 명확하게 식벽할 수 있도록 명명
...
# - 이름에 공백이나 특수문자가 포함된 경우 식벽을 위한 목적

# 따움표
# 문자열을 저장하는데 사용
# : 태이블명이나 컬럼명으로 사용하는것을 권장하지 않습니다.
